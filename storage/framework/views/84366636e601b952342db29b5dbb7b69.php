...
<section class="product_banner">
   <div class="container-fluid p-0">
       <div class="row">
         ...
         <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->is('woman/clothing') || (isset($currentCategory) && $currentCategory->slug == 'clothing' && isset($genderSlug) && $genderSlug == 'woman')): ?>
           <img src="<?php echo e(asset('images/Spiderman_restock_Home_page-1_8VM1dtD.avif')); ?>" class="img-fluid w-100 hide-mobile" style="aspect-ratio: 1500/384; object-fit: cover; object-position: center;" alt="">
           <img src="<?php echo e(asset('images/Spiderman_restock_Home_page-1_8VM1dtD.avif')); ?>" class="img-fluid hidden-large w-100" alt="">
         ...
         <?php elseif(isset($markdownBanners) && $markdownBanners->count() > 0): ?>
            <div class="container my-5">
                <div class="row justify-content-center">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $markdownBanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $colClass = $banner->orientation === 'vertical' ? 'col-lg-4 col-md-6' : 'col-lg-8 col-md-10';
                        ?>
                        <div class="<?php echo e($colClass); ?> mb-5 text-center">
                            ...
                            <img src="<?php echo e(asset('storage/' . $banner->image)); ?>" class="img-fluid" style="width: 100%; border-radius: 12px; object-fit: cover; object-position: center;" alt="Mark Down Banner">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($banner->link): ?>
                                </a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
    ...
    <div class="container-fluid">
                    ...
                    <div class="product_listing_count pdct_slct-sort d-flex justify-content-end">
                        ...
                        <p style="font-size:15px;">
                            <?php echo e(isset($category) ? $category->name : 'Products'); ?> - <span id="product-count-display"><?php echo e(isset($products) ? $products->count() : 0); ?></span> items
                        </p>
                        </div>
...
<!-- FILTER COMPONENT END -->
    ...
    <div id="categoryList">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($currentCategory) && $currentCategory->children->isNotEmpty()): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $currentCategory->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <label class="category-item" style="color: #0f7c6b; font-weight: bold;">
                    <span>
                        <input type="checkbox" class="category-filter-checkbox" value="<?php echo e($childCat->name); ?>"> 
        ...
        <?php else: ?>
            ...
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($availableCategories) > 0): ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $availableCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <label class="category-item" style="color: #0f7c6b; font-weight: bold;">
                        <span>
                            <input type="checkbox" class="category-filter-checkbox" value="<?php echo e($cName); ?>"> 
                            <?php echo e($cName); ?>
                ...
                <hr style="margin:10px 0; border-top: 1px dashed #ccc;">
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($availableGenders) > 0): ?>
                <div class="filter-title mt-4">GENDER</div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $availableGenders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gKey => $gLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <label class="category-item" style="color: #0f7c6b; font-weight: bold;">
                        <span>
                            <input type="checkbox" class="gender-filter-checkbox" value="<?php echo e($gKey); ?>"> 
                            <?php echo e($gLabel); ?>
    ...
    <div id="priceList">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $priceRanges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $range): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <label class="category-item">
                <span><input type="radio" name="price_range" value="<?php echo e($range['value']); ?>" class="price-filter-radio"> <?php echo e($range['label']); ?></span>
                <span><?php echo e($range['count']); ?></span>
            </label>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
    </div>
            ...
            <div class="col-md-9">
                ...
                <div class="product_shwings">
                    ...
                    <div class="pdct_showing_main_list">
                        <div class="row">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($products) && $products->count() > 0): ?>
                                  ...
                                  ?>
                                  <div class="col-md-3 col-6 product" data-category="<?php echo e($product->category ? $product->category->name : ''); ?>" data-gender="<?php echo e($topCategoryName); ?>" data-price="<?php echo e($product->price); ?>" data-sizes="<?php echo e(json_encode($product->sizes ?? [])); ?>">
                                      <div class="product-card d-none d-lg-block mt-2">
                                          <div class="card image-hover" style="border:none!important;">
                                              <a href="<?php echo e(route(\App\Constants\RouteNames::SINGLE_PRODUCT_INDEX, ['slug' => $product->slug])); ?>">
                                                  ...
                                                  ?>
                                                  <img src="<?php echo e($image1); ?>" class="card-img-top first-img" alt="<?php echo e($product->name); ?>" style="aspect-ratio: 3/4; object-fit: cover; width: 100%; background-color: #f5f5f5;">
                                                  <img src="<?php echo e($image2); ?>" class="card-img-top second-img" alt="<?php echo e($product->name); ?>" style="aspect-ratio: 3/4; object-fit: cover; width: 100%; background-color: #f5f5f5;">
                                              </a>
                                              <?php
                                              ...
                                              ?>
                                              <div class="wishlistIcon pl-1 pb-2 pr-1 wishlist" data-product-id="<?php echo e($product->id); ?>">
                                                  <svg width="18" height="18" viewBox="0 0 24 24" fill="<?php echo e($heartFill); ?>">
                                                      <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3 c1.74 0 3.41 0.81 4.5 2.09 C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5 c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" stroke="<?php echo e($heartStroke); ?>" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                  </svg>
                                              </div>
                                              <div class="product-detail p-1 product-title">
                                                  <h5 class="text-left" style="font-size: 14px; text-transform: capitalize; padding-bottom: 4px; margin-bottom: 4px;"><?php echo e($product->name); ?></h5>
                                                  <span style="font-size: 11px;"><?php echo e($product->category ? $product->category->name : 'Category'); ?></span>
                                                  <p class="item-price" style="margin-top: 4px;">
                                                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->discount_price): ?>
                                                          <span class="offer_price_number">₹<?php echo e(round($product->discount_price)); ?></span>
                                                          <span class="price_number" style="text-decoration: line-through; color: #999; margin-left: 5px;">₹<?php echo e(round($product->price)); ?></span>
                                                      <?php else: ?>
                                                          <span class="offer_price_number">₹<?php echo e(round($product->price)); ?></span>
                                                      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                  </p>
                                              </div>
                                          </div>
                                      ...
                                      <div class="product-card d-block d-lg-none mt-2">
                                          <div class="card image-hover">
                                              <div class="swiper product-slide-swiper">
                                                  <div class="swiper-wrapper">
                                                      <div class="swiper-slide">
                                                          <a href="<?php echo e(route(\App\Constants\RouteNames::SINGLE_PRODUCT_INDEX, ['slug' => $product->slug])); ?>">
                                                              <img src="<?php echo e($image1); ?>" class="img-fluid desktop-slide" alt="<?php echo e($product->name); ?>" style="aspect-ratio: 3/4; object-fit: cover; width: 100%; background-color: #f5f5f5;">
                                                          </a>
                                                      </div>
                                                  </div>
                                              ...
                                              <div class="product-detail p-1 product-title">
                                                  <div class="d-flex justify-content-between align-items-center">
                                                      <div>
                                                          <h5 class="text-left product-title width-small" style="font-size: 12px; text-transform: capitalize; padding-bottom: 4px; margin-bottom: 4px;"><?php echo e($product->name); ?></h5>
                                                      </div>
                                                  </div>
                                                  <div>
                                                       <span style="font-size: 10px;"><?php echo e($product->category ? $product->category->name : 'Category'); ?></span>
                                                  </div>
                                                  <p class="item-price" style="margin-top: 4px;">
                                                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->discount_price): ?>
                                                          <span class="offer_price_number">₹<?php echo e(round($product->discount_price)); ?></span>
                                                          <span class="price_number" style="text-decoration: line-through; color: #999; margin-left: 5px; font-size: 10px;">₹<?php echo e(round($product->price)); ?></span>
                                                      <?php else: ?>
                                                          <span class="offer_price_number">₹<?php echo e(round($product->price)); ?></span>
                                                      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                  </p>
...
<?php /**PATH D:\anu mostech\delunh\resources\views/website/product.blade.php ENDPATH**/ ?>