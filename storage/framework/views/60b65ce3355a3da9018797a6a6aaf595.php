                        ...
                        <div class="left_cart-side">
                            ...
                            <div class="cart-selection-bar">
                                <div class="selection-text">
                                    ...
                                    ?>
                                    <span id="selected-items-count"><?php echo e($totalItems); ?></span>/<span id="total-items-count"><?php echo e($totalItems); ?></span> ITEMS SELECTED <span id="selected-items-total-top">(₹ <?php echo e($grandTotal); ?>)</span>
                                </div>
                            ...
                            <div class="cart--itrm--row">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="tss-cart-item" id="cart-item-row-<?php echo e($key); ?>">
                                    <div class="tss-item-main">
                                        <div class="tss-item-checkbox">
                                            <div class="tss-checkbox-container">
                                                <input type="checkbox" checked="" id="cart-item-<?php echo e($key); ?>" class="tss-check-input item-checkbox" data-price="<?php echo e($item['price'] * $item['quantity']); ?>" onchange="updateCartTotals()">
                                                <label for="cart-item-<?php echo e($key); ?>" class="tss-check-label">
                                                    <i class="fa fa-check"></i>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="tss-item-img">
                                            <img src="<?php echo e(asset('storage/' . $item['image'])); ?>" alt="<?php echo e($item['name']); ?>" onerror="this.src='https://assets.myntassets.com/f_webp,dpr_1.0,q_60,w_210,c_limit,fl_progressive/assets/images/productimage/2021/5/19/0ef44f9b-61ef-4212-a56c-a1a08eebaec41621425364224-1.jpg'">
                                        </div>
                                        <div class="tss-item-details">
                                            <div class="tss-title-price">
                                                <div>
                                                    <h5 class="tss-item-title"><?php echo e($item['name']); ?></h5>
                                                    <p class="tss-item-sub"><?php echo e($item['category']); ?></p>
                                                </div>
                                                <div class="tss-price-section">
                                                    <p class="tss-current-price">₹ <?php echo e($item['price']); ?> <span class="tss-old-price">₹ <?php echo e($item['old_price']); ?></span></p>
                                            ...
                                            <div class="tss-selectors">
                                                <div class="tss-select-wrapper">
                                                    <select class="form-select" disabled>
                                                        <option>Size: <?php echo e($item['size']); ?></option>
                                                    </select>
                                                </div>
                                                <div class="tss-select-wrapper">
                                                    <select class="form-select" disabled>
                                                        <option>Qty: <?php echo e($item['quantity']); ?></option>
                                                    </select>
                                                </div>
                                            </div>

                                            <div class="tss-item-footer">
                                                <button class="tss-footer-btn" onclick="removeFromCart('<?php echo e($key); ?>')">Remove</button>
                    ...
                    <div class="col-md-3">
                        <div class="right_cart-side">
                            ...
                            <div class="price-details-section">
                                ...
                                <div class="price-row">
                                    <span>Bag Total</span>
                                    <span id="bag-total-price">₹<?php echo e($grandTotal); ?></span>
                                </div>
                                <div class="price-row">
                                ...
                                <div class="price-row grand-total">
                                    ...
                                    <span id="grand-total-price">₹<?php echo e($grandTotal); ?></span>
                                </div>
                                <button class="pay-button" style="background: #117a7a; border-radius: 4px;" onclick="location.href='<?php echo e(route(\App\Constants\RouteNames::CHECKOUT)); ?>'">
                                    PLACE ORDER
                                </button>
                            </div>
                        </div>
                ...
                <div class="row mt-4 mb-5">
                    <div class="col-md-9">
                        <div class="cart-related-items" style="background: #fff; border: 1px solid #e6e7e8; border-radius: 4px; padding: 15px;">
                            ...
                            <div class="row">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($relatedProducts)): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="col-md-4 mb-3">
                                        <div style="border: 1px solid #e6e7e8; border-radius: 4px; overflow: hidden; text-align: center;">
                                            <a href="<?php echo e(route(\App\Constants\RouteNames::SINGLE_PRODUCT_INDEX, ['slug' => $relProduct->slug])); ?>">
                                                <img src="<?php echo e(asset('storage/' . ($relProduct->images && count($relProduct->images) > 0 ? $relProduct->images[0] : ''))); ?>" alt="<?php echo e($relProduct->name); ?>" style="width: 100%; height: 200px; object-fit: cover;">
                                                <div style="padding: 10px; font-size: 12px; text-align: left;">
                                                    <h6 style="font-size: 12px; font-weight: 700; margin: 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo e($relProduct->name); ?></h6>
                                                    <p style="margin: 0; color: #8c8d8f;"><?php echo e($relProduct->category ? $relProduct->category->name : ''); ?></p>
                                                    <p style="margin: 5px 0 0 0; color: #e02b2b; font-weight: 700;">₹ <?php echo e($relProduct->price); ?></p>
                                                </div>
                                            </a>
                                            <button style="width: 100%; padding: 10px; border: none; border-top: 1px solid #e02b2b; background: transparent; color: #e02b2b; font-weight: 700; font-size: 12px;" onclick="location.href='<?php echo e(route(\App\Constants\RouteNames::SINGLE_PRODUCT_INDEX, ['slug' => $relProduct->slug])); ?>'">ADD NOW</button>
                                        </div>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php echo $__env->make('website.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\anu mostech\delunh\resources\views/website/cart.blade.php ENDPATH**/ ?>