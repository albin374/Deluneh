                ...
                <div class="row">
                    <div class="col-md-7 product-info-wrapper-sticky1">
                        <div class="product_detail_slider mobile-none">
                            <div class="product_grid_details" style="<?php echo e((!$product->images || count($product->images) <= 1) ? 'grid-template-columns: 1fr;' : ''); ?>">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                      <div class="image_grid">
                                        <div class="image-grid-box">
                                          <img src="<?php echo e(Storage::url($image)); ?>" class="img-fluid" alt="<?php echo e($product->name); ?>">
                                        </div>
                                      </div>
                        ...
                        <div class="product-detail-right">
                            <div class="heading-product">
                              <div class="prdct_title_block">
                                <h1 class="fw-600"><?php echo e($product->name); ?></h1>
                                <p><?php echo e(optional($product->category)->name ?? 'Product'); ?></p>
                              </div>
                            </div>
                            <div class="prdct-detail-price">
                                <div class="div-detail-price-row">
                                    <span class="prd-offer-price">₹ <?php echo e($product->discount_price ?? $product->price); ?></span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->discount_price && $product->discount_price < $product->price): ?>
                                        <span class="del_price_off" style="font-size:16px; margin-left:10px;"><del>₹<?php echo e($product->price); ?></del></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                ...
                                <div class="size-custom-label mt-2">
                                    ...
                                    <ul class="size-label-form prdct-detail-size-blck">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->sizes && is_array($product->sizes) && count($product->sizes) > 0): ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $product->sizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <li class="size_block-div">
                                                    <input type="radio" id="size_<?php echo e($size); ?>" name="size" value="<?php echo e($size); ?>" />
                                                    <label for="size_<?php echo e($size); ?>" class="size-label">
                                                        <?php echo e($size); ?>
                            ...
                            <div class="product-detail-button add_sticky_mobile_cart">
                                <button class="prdct-button bg-button" id="add-to-cart-btn" data-product-id="<?php echo e($product->id); ?>">
                                ...
                                ?>
                                <button class="prdct-button transparent-button" id="addToWishlistBtn" data-product-id="<?php echo e($product->id); ?>">
                                    ...
                                    <span id="wishlistBtnText"><?php echo e($btnText); ?></span>
                                </button>
                            </div>  
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse show1" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                      <div class="accordion-body">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->material_care): ?>
                                        <div class="mtop_12">
                                            <h4>Material & Care</h4>
                                            <p><?php echo e($product->material_care); ?></p>
                                        </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->country_of_origin): ?>
                                        <div class="mtop_12">
                                            <h4>Country of Origin</h4>
                                            <p><?php echo e($product->country_of_origin); ?></p>
                                        </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                      </div>
                                    </div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="swiper-slide">
                                        ...
                                        <div class="card image-hover" style="border:none!important;">
                                            <a href="<?php echo e(route(\App\Constants\RouteNames::SINGLE_PRODUCT_INDEX, ['slug' => $related->slug])); ?>">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($related->images && count($related->images) > 0): ?>
                                                <img src="<?php echo e(Storage::url($related->images[0])); ?>" class="card-img-top first-img" alt="<?php echo e($related->name); ?>" style="aspect-ratio: 3/4; object-fit: cover; width: 100%; background-color: #f5f5f5;">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($related->images) > 1): ?>
                                                    <img src="<?php echo e(Storage::url($related->images[1])); ?>" class="card-img-top second-img" alt="<?php echo e($related->name); ?>" style="aspect-ratio: 3/4; object-fit: cover; width: 100%; background-color: #f5f5f5;">
                                                <?php else: ?>
                                                    <img src="<?php echo e(Storage::url($related->images[0])); ?>" class="card-img-top second-img" alt="<?php echo e($related->name); ?>" style="aspect-ratio: 3/4; object-fit: cover; width: 100%; background-color: #f5f5f5;">
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <?php else: ?>
                                                <img src="https://prod-img.thesouledstore.com/public/theSoul/uploads/catalog/product/1712574694_1119733.jpg?w=300&dpr=1" class="card-img-top first-img" alt="<?php echo e($related->name); ?>" style="aspect-ratio: 3/4; object-fit: cover; width: 100%; background-color: #f5f5f5;">
                                                <img src="https://prod-img.thesouledstore.com/public/theSoul/uploads/catalog/product/1753184953_8196988.jpg?w=300&dpr=1" class="card-img-top second-img" alt="<?php echo e($related->name); ?>" style="aspect-ratio: 3/4; object-fit: cover; width: 100%; background-color: #f5f5f5;">
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </a>
                                            <div class="product-detail p-1 product-title">
                                                
                                                        <h5 class="text-left" style="font-size: 14px;"><?php echo e($related->name); ?></h5>
                                                        <span style="font-size: 11px;"><?php echo e(optional($related->category)->name ?? 'Product'); ?></span>
                                                    
                                                <p class="item-price">
                                                    <span class="offer_price_number">₹<?php echo e($related->discount_price ?? $related->price); ?></span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($related->discount_price && $related->discount_price < $related->price): ?>
                                                        <span class="price_number">₹<?php echo e($related->price); ?></span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </p>
                                            </div>
                                        </div>
    ...
    if(addToCartBtn) {
        addToCartBtn.addEventListener('click', function(e) {
            ...
            if (this.innerText.includes('GO TO CART')) {
                window.location.href = '<?php echo e(route(\App\Constants\RouteNames::CART)); ?>';
                return;
            }
...
<?php /**PATH D:\anu mostech\delunh\resources\views/website/single-product.blade.php ENDPATH**/ ?>