        ...
        <div class="col-md-4">
            <div class="right-cart-side">
                ...
                <div class="price-details-section">
                    <div class="summary-items-list mb-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($cartItems) && count($cartItems) > 0): ?>
                            ...
                            <div class="cart-summary-item">
                                <img src="<?php echo e(asset('storage/' . $item['image'])); ?>" alt="Product" onerror="this.src='https://prod-img.thesouledstore.com/public/theSoul/uploads/catalog/product/1730887726_1292079.jpg?w=480&dpr=1'">
                                <div class="info">
                                    <h6><?php echo e($item['name']); ?></h6>
                                    <p>Size: <?php echo e($item['size']); ?> | Qty: <?php echo e($item['quantity']); ?></p>
                                </div>
                                <div class="price">₹<?php echo e($item['price'] * $item['quantity']); ?></div>
                            </div>
                    ...
                    <div class="price-row">
                        <span>Bag Total</span>
                        <span>₹<?php echo e($grandTotal ?? 0); ?></span>
                    </div>
                    <div class="price-row">
...
<?php echo $__env->make('website.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\anu mostech\delunh\resources\views/website/checkout.blade.php ENDPATH**/ ?>