                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($banners) && $banners->count() > 0): ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="swiper-slide" <?php if($banner->link): ?> onclick="location.href='<?php echo e($banner->link); ?>'" style="cursor: pointer;" <?php endif; ?>>
                                    <img src="<?php echo e(Storage::url($banner->image)); ?>" class="img-fluid desktop-slide" alt="Banner">
                                </div>
                    ...
                    <div class="col-12">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($i = 0; $i < 10; $i++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    ...
                                    <div class="product-card d-lg-none d-block">
                                        <div class="card image-hover">
                                            ...
                                            <!-- <img src="/images/f1.webp" class="card-img-top first-img" alt="Product <?php echo e($i + 1); ?>"> -->
                                            <!-- <img src="/images/f2.webp" class="card-img-top second-img" alt="Product <?php echo e($i + 1); ?>"> -->
                        ...
                        <!--                    </div>-->
                                    ...
                                    <div class="product-card d-lg-block d-none">
                                        <div class="card image-hover">
                                            <img src="/images/f3.webp" class="card-img-top first-img" alt="Product <?php echo e($i + 1); ?>">
                                            <img src="/images/f2.webp" class="card-img-top second-img" alt="Product <?php echo e($i + 1); ?>">
                            ...
                            <!-- <div class="swiper-slide">
                                <div class="product-card">
                                    <div class="card">
                                        <img src="/images/f2.webp" class="card-img-top" alt="Product <?php echo e($i + 1); ?>">
                                        <div class="product-detail p-2">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h3 class="product-title fw-700">DeLuneh@ <?php echo e($i + 1); ?></h3>
                            ...
                            <!-- <div class="swiper-slide">
                                <div class="product-card">
                                    <div class="card">
                                        <img src="/images/f3.webp" class="card-img-top" alt="Product <?php echo e($i + 1); ?>">
                                        <div class="product-detail p-2">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h3 class="product-title fw-700">DeLuneh@ <?php echo e($i + 1); ?></h3>
...
<?php echo $__env->make('website.footer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\anu mostech\delunh\resources\views/website/home1.blade.php ENDPATH**/ ?>