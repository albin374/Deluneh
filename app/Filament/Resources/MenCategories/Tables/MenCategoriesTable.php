...
namespace App\Filament\Resources\MenCategories\Tables;
        ...
        return $table
            ...
            ->recordActions([
                \Filament\Actions\Action::make('view_children')
                    ...
                    ->modalHeading(fn (\App\Models\MenCategory $record) => "Children of {$record->name}")
                    ->modalContent(fn (\App\Models\MenCategory $record) => view('filament.categories.children-modal', ['record' => $record]))
                    ->modalSubmitAction(false)
                    ->modalCancelActionLabel('Close')
                    ->visible(fn (\App\Models\MenCategory $record) => $record->children()->exists()),
                EditAction::make(),
            ])
            ->toolbarActions([
