        ...
        return $table
            ...
            ->recordActions([
                \Filament\Actions\Action::make('view_children')
                    ...
                    ->modalHeading(fn (\App\Models\Category $record) => "Children of {$record->name}")
                    ->modalContent(fn (\App\Models\Category $record) => view('filament.categories.children-modal', ['record' => $record]))
                    ->modalSubmitAction(false)
                    ->modalCancelActionLabel('Close')
                    ->visible(fn (\App\Models\Category $record) => $record->children()->exists()),
                EditAction::make(),
            ])
            ->toolbarActions([
