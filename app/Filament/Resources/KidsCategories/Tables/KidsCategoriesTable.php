...
namespace App\Filament\Resources\KidsCategories\Tables;
        ...
        return $table
            ...
            ->recordActions([
                \Filament\Actions\Action::make('view_children')
                    ...
                    ->modalHeading(fn (\App\Models\KidsCategory $record) => "Children of {$record->name}")
                    ->modalContent(fn (\App\Models\KidsCategory $record) => view('filament.categories.children-modal', ['record' => $record]))
                    ->modalSubmitAction(false)
                    ->modalCancelActionLabel('Close')
                    ->visible(fn (\App\Models\KidsCategory $record) => $record->children()->exists()),
                EditAction::make(),
            ])
            ->toolbarActions([
